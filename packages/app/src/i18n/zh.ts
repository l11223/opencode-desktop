...
export const dict = {
  ...
  "command.terminal.next": "下一个终端",
  "command.terminal.next.description": "切换到下一个终端标签页",
  "command.terminal.previous": "上一个终端",
  "command.terminal.previous.description": "切换到上一个终端标签页",
  ...
  "search.truncated": "结果已截断，请缩小搜索范围。",
  "search.error": "错误",
