export const dict = {
  ...
  "command.terminal.next.description": "Switch to the next terminal tab",
  "command.terminal.previous": "Previous terminal",
  "command.terminal.previous.description": "Switch to the previous terminal tab",
  "command.terminal.search": "Find in terminal",
  "command.terminal.splitRight": "Split right",
  "command.terminal.splitRight.description": "Split terminal horizontally",
  "command.terminal.splitDown": "Split down",
  "command.terminal.splitDown.description": "Split terminal vertically",
  "command.terminal.focusLeft": "Focus left pane",
  "command.terminal.focusRight": "Focus right pane",
  "command.terminal.focusUp": "Focus pane above",
  "command.terminal.focusDown": "Focus pane below",
  "command.terminal.closePane": "Close pane",
  "command.terminal.closePane.description": "Close the focused terminal pane",
  ...
  "command.search.global": "Search in files",
  ...
  "terminal.reconnecting": "Reconnecting ({{attempt}}/{{max}})...",
  "terminal.reconnectFailed": "Failed to connect after {{max}} attempts",
  ...
  "search.truncated": "Results truncated. Narrow your search.",
  "search.error": "Error",
