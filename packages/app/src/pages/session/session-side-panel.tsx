...
export function SessionSidePanel(props: {
  ...
  const sidePanelWidth = () => {
    if (!props.reviewOpen) return props.layout.fileTree.width()
    return props.layout.sidePanel.width()
  }
  ...
  return (
    <Show when={props.open}>
      <aside
        ...
        class="relative min-w-0 shrink-0 h-full border-l border-border-weak-base flex"
        style={{ width: `${sidePanelWidth()}px`, "min-width": "280px" }}
      >
          ...
          >
            ...
            >
              <Tabs
                ...
                data-scope="filetree"
              >
                <Tabs.List class="border-b border-border-base">
                ...
                <Tabs.Content value="changes" class="bg-background-base px-3 py-0 thin-scrollbar">
                  <Switch>
                ...
                <Tabs.Content value="all" class="bg-background-base px-3 py-0 thin-scrollbar">
                  <ContextMenu>
        ...
        <Show when={props.reviewOpen}>
          <ResizeHandle
            direction="horizontal"
            edge="start"
            size={props.layout.sidePanel.width()}
            min={280}
            max={typeof window === "undefined" ? 800 : window.innerWidth * 0.5}
            collapseThreshold={200}
            onResize={props.layout.sidePanel.resize}
