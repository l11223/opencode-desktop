...
export const useSessionCommands = (input: {
  ...
  const viewCommands = createMemo(() => [
    ...
    {
      id: "search.global",
      title: input.language.t("command.search.global"),
      category: input.language.t("command.category.search"),
      keybind: "mod+shift+f",
      onSelect: () => input.toggleSearch(),
    },
    {
      id: "input.focus",
    ...
    {
      id: "terminal.next",
      title: input.language.t("command.terminal.next"),
      description: input.language.t("command.terminal.next.description"),
      category: input.language.t("command.category.terminal"),
      keybind: "ctrl+tab",
      disabled: input.terminal.all().length < 2,
      onSelect: () => {
        input.terminal.next()
        input.view().terminal.open()
      },
    },
    {
      ...
      title: input.language.t("command.terminal.previous"),
      description: input.language.t("command.terminal.previous.description"),
      category: input.language.t("command.category.terminal"),
      keybind: "ctrl+shift+tab",
      disabled: input.terminal.all().length < 2,
      onSelect: () => {
        input.terminal.previous()
        input.view().terminal.open()
      },
    },
    {
      id: "terminal.search",
      title: input.language.t("command.terminal.search"),
      category: input.language.t("command.category.terminal"),
      keybind: "mod+f",
    },
    {
      id: "terminal.splitRight",
      title: input.language.t("command.terminal.splitRight"),
      description: input.language.t("command.terminal.splitRight.description"),
      category: input.language.t("command.category.terminal"),
      keybind: "mod+d",
      disabled: input.terminal.all().length === 0,
      onSelect: () => {
        const layout = input.terminal.getLayout()
        const id = layout?.focused ?? input.terminal.active()
        if (id) input.terminal.split(id, "horizontal")
      },
    },
    {
      id: "terminal.splitDown",
      title: input.language.t("command.terminal.splitDown"),
      description: input.language.t("command.terminal.splitDown.description"),
      category: input.language.t("command.category.terminal"),
      keybind: "mod+shift+d",
      disabled: input.terminal.all().length === 0,
      onSelect: () => {
        const layout = input.terminal.getLayout()
        const id = layout?.focused ?? input.terminal.active()
        if (id) input.terminal.split(id, "vertical")
      },
    },
    {
      id: "terminal.focusLeft",
      title: input.language.t("command.terminal.focusLeft"),
      category: input.language.t("command.category.terminal"),
      keybind: "mod+alt+arrowleft",
      onSelect: () => input.terminal.focusDirection("left"),
    },
    {
      id: "terminal.focusRight",
      title: input.language.t("command.terminal.focusRight"),
      category: input.language.t("command.category.terminal"),
      keybind: "mod+alt+arrowright",
      onSelect: () => input.terminal.focusDirection("right"),
    },
    {
      id: "terminal.focusUp",
      title: input.language.t("command.terminal.focusUp"),
      category: input.language.t("command.category.terminal"),
      keybind: "mod+alt+arrowup",
      onSelect: () => input.terminal.focusDirection("up"),
    },
    {
      id: "terminal.focusDown",
      title: input.language.t("command.terminal.focusDown"),
      category: input.language.t("command.category.terminal"),
      keybind: "mod+alt+arrowdown",
      onSelect: () => input.terminal.focusDirection("down"),
    },
    {
      id: "terminal.closePane",
      title: input.language.t("command.terminal.closePane"),
      description: input.language.t("command.terminal.closePane.description"),
      category: input.language.t("command.category.terminal"),
      disabled: !input.terminal.getLayout()?.layout,
      onSelect: () => {
        const layout = input.terminal.getLayout()
        const id = layout?.focused
        if (id) input.terminal.removeSplit(id)
      },
    },
    {
      id: "steps.toggle",
