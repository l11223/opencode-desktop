  ...
  async function loadSessions(directory: string) {
    ...
    const promise = loadRootSessionsWithFallback({
      ...
      .then((x) => {
        ...
        const nonArchived = all.filter((s) => !s.time?.archived)
        const archived = all.filter((s) => !!s.time?.archived && !s.parentID)
        ...
        setStore("session", reconcile([...sessions, ...archived], { key: "id" }))
